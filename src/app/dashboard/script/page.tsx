  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 1100 }}>
      ...
      <div className="card" style={{ padding: 20 }}>
        ...
        <div style={{ display: "flex", gap: 16, fontSize: 12, color: "var(--text-muted)" }}>
          {[
            ...
            { icon: <ImageIcon size={11} />,   text: "씬별 영상 프레임 자동 캡처" },
          ].map(({ icon, text }, i) => (
      ...
      {result && (
        <>
          {/* 메타 정보 */}
          <div style={{ padding: "10px 14px", borderRadius: 8, background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.2)", display: "flex", alignItems: "center", gap: 8, fontSize: 12 }}>
            ...
            <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--border-subtle)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                ...
                <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 2 }}>
                  GPT-4o 생성 {result.script.length}개 장면 · 씬별 영상 프레임 포함 · 클릭하여 편집
                </div>
              </div>
            ...
            {result.script.map((line, i) => {
              ...
              return (
                <div key={i}
                  ...
                  {/* 씬 프레임 */}
                  <div style={{ width: 172, flexShrink: 0, borderRight: "1px solid var(--border-subtle)", padding: 6, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.15)" }}>
                    {frame ? (
